...
public class Exercicio6POO {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Código do item: " + inv.getCodigoItem());
        System.out.println("Descrição: " + inv.getDescricao());
        System.out.println("Quantidade vendida: " + inv.getQtdVendida());
        System.out.println("Preço unitário R$ " + inv.getPrecoUni());
        
        // Exibição valor total da compra
        System.out.println("Valor total da compra R$ " + inv.getInvoiceAmount());
